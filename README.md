...
How we built it 🔨
UX Design & Branding: We first created wireframes with Figma to map out an intuitive experience for users Web Development: We used php, JavaScript, CSS, and the Twilio Programmable Voice API. The Twilio API allows us to generate outgoing calls to verified phone numbers.
